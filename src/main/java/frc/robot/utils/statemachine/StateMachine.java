/**
 * The state machine code for this was taken directly from CC Shambot's ShamLib
 * https://github.com/CCShambots/ShamLib/tree/main/SMF
 */
...
public abstract class StateMachine<E extends Enum<E>> extends SubsystemBase {
  ...
  private final double transitionTimeOut = 2; // seconds
